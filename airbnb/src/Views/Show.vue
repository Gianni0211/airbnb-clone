<template>
    <div class="py-10 container-xl lg:container px-8">
        ...
        <ul class="flex justify-between mt-3">
            ...
            <div
                class="md:flex w-32 justify-between text-gray-700 mr-5 hidden "
            >
                ...
                <li class="flex items-center ml-2">
                    ...
                    ><span class="underline">Salva</span>
                </li>
            </div>
        </ul>
            ...
            <div class="md:w-8/12 w-full">
                ...
                <div class="my-5 text-lg">
                    <p class="mb-5">
                        ...
                        elit. Sed earum deserunt eius quo, quaerat et eum ullam
                        nulla aspernatur doloribus quod aut, sequi voluptatem.
                        Blanditiis, quas iusto. Reiciendis, expedita quasi! At
                        possimus, nostrum incidunt itaque quibusdam ipsum.
                        Suscipit asperiores blanditiis provident eos sed.
                        Praesentium modi, neque autem quisquam pariatur
                        voluptatum!
                    </p>

                    <a href="#" class="underline font-semibold  mt-20"
                        >Contatta l'host</a
                    >
                </div>
            </div>
